...
imgmap.prototype.area_count = function() {
    return this.areas.filter(function(item) { return item != null }).length;
}
...
imgmap.prototype.img_mousedown = function(e) {
    if (this.viewmode === 1) { return; } //exit if preview mode
    if (this.config.maxArea && this.area_count() >= this.config.maxArea && this.is_drawing === 0) { return; }
