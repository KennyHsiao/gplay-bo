				...
				return {
								...
								},
								{
									...
									[
										...
										},
                                        {
                                            id : 'chkShowInfo',
                                            type : 'checkbox',
                                            label : editor.lang.youtube.chkShowInfo,
                                            'default' : editor.config.youtube_showinfo != null ? editor.config.youtube_showinfo : false
                                        },
										{
											id : 'chkOlderCode',
											type : 'checkbox',
					...
					onOk: function()
					{
						...
						if ( this.getContentElement( 'youtubePlugin', 'txtEmbed' ).isEnabled() )
						{
                            ...
                            if ( this.getContentElement( 'youtubePlugin', 'chkShowInfo' ).getValue() === false )
                            {
