...
icon_details:"詳細",icon_edit:"編輯",icon_delete:"刪除",confirm_closing:"請確認是否取消修改!",confirm_deleting:"是否刪除日程?",section_description:"描述",section_time:"時間範圍",full_day:"整天",confirm_recurring:"請確認是否將日程設為重複模式?",section_recurring:"重複週期",button_recurring:"禁用",button_recurring_open:"啟用",button_edit_series:"編輯系列",button_edit_occurrence:"編輯實例",agenda_tab:"議程",date:"日期",description:"說明",year_tab:"今年",week_agenda_tab:"議程",grid_tab:"電網",drag_to_create:"Drag to create",drag_to_move:"Drag to move",message_ok:"OK",message_cancel:"Cancel",
