    ...
    */
    ...
    'redis' => [
        ...
        'default' => [
            ...
            'sentinel_timeout' => floatval(env('REDIS_SENTINEL_TIMEOUT', 0)),
            'sentinel_persistent' => env('REDIS_SENTINEL_PERSISTENT'),
            'sentinel_retry_interval' => intval(env('REDIS_SENTINEL_RETRY_INTERVAL', 0)),
            'sentinel_read_timeout' => intval(env('REDIS_SENTINEL_READ_TIMEOUT', 0)),
