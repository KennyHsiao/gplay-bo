...
trait ModelTree
{
     ...
     * @return array
     */
    protected function buildNestedArray(array $nodes = [], $parentId = null)
    {
        $branch = [];
     ...
     */
    public static function selectOptions($queryCallback = null)
    {
        
        $self = (new static());
        $self->withQuery($queryCallback);
        $options = $self->buildSelectOptions();

        return collect($options)->prepend(' - ', null)->all();
    }
     ...
     * @return array
     */
    protected function buildSelectOptions(array $nodes = [], $parentId = null, $prefix = '')
    {
