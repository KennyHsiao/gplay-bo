...
class Deposit extends RowAction
{
    ...
    protected function script()
    {
        ...
        return <<<SCRIPT
$('.grid-deposit').on('click', function() {
...
SCRIPT;
    ...
    public function render()
    {
        ...
        return "<a class='btn btn-sm btn-danger grid-deposit' data-merchant='{$this->merchantCode}' data-id='{$this->account}' style='margin-left:5px;'>".trans('儲值')."</a>";
    }
