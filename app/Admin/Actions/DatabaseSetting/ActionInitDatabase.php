...
class ActionInitDatabase extends RowAction
{
    ...
    protected function script()
    {
        ...
        $trans = [
            ...
            'url'                 => route('database.init')
        ];
        return <<<SCRIPT

$('.grid-init-database').on('click', function () {
    swal.fire({
        title: "{$trans['title']}",
        icon: 'warning',
...
SCRIPT;
    ...
    public function render()
    {
        ...
        return "<a class='btn btn-sm btn-danger grid-init-database' data-id='{$this->id}' style='margin-left:5px;'>".trans('交易資料庫')."</a>";
    }
