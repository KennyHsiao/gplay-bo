...
return [
    ...
    */
    ...
    'before_or_equal'      => '注意: :attribute 必须为一个在 :date 之前或相同的时间.',
    'between'              => [
    ...
    'distinct'             => '注意: :attribute 字段具有重復的值.',
    ...
    'ipv4'                 => '注意: :attribute 必须为合法的IPv4地址.',
    'ipv6'                 => '注意: :attribute 必须为合法的IPv6地址.',
    'json'                 => '注意: :attribute 必须为合法的JSON格式数据.',
    'max'                  => [
        'numeric' => '注意: :attribute 不可以比 :max 大.',
        'file'    => '注意: :attribute 不能超过 :max KB.',
    ...
    'size'                 => [
        ...
        'file'    => '注意: :attribute 必须包含 :size KB.',
