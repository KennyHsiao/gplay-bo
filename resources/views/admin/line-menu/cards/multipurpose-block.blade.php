<div class="form-horizontal card box" style="position: relative; padding-right: 50px; height: 200px;">
    ...
    <div class="group custom-select">
        <select class="inputMaterial" name="menu_type" data-field="menu_type">
            <option value></option>
    ...
    <div class="group custom-select">
        <select class="inputMaterial" name="menu_attr" data-field="menu_attr">
        {{--  --}}
        </select>
        <span class="highlight"></span>
        <span class="bar"></span>
    ...
    <div class="group custom-select select">
        <select class="inputMaterial" name="menu_uri" data-field="menu_uri">
        {{--  --}}
        </select>
        <span class="highlight"></span>
        <span class="bar"></span>
    ...
    <div class="group custom-select input" style="display:none; z-index:999;">
        <textarea class="inputMaterial" name="menu_uri" data-field="menu_uri" cols="30" rows="1"></textarea>
        <span class="highlight"></span>
        <span class="bar"></span>
        <label>文字</label>
    </div>
